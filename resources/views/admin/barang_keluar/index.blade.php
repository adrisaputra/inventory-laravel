					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="{{ url('/barang_keluar/search') }}" method="GET">
									<div class="row">
										<div class="col-md-9">
											@if(Auth::user()->group==1)
												<a href="{{ url('/barang_keluar/create') }}" class="btn btn-success btn-flat" title="Tambah Data">Tambah</a>
												<a href="{{ url('/barang_keluar') }}" class="btn btn-warning btn-flat" title="Refresh halaman">Refresh</a>
											@else
												<a href="{{ url('/barang_keluar') }}" class="btn btn-warning btn-flat" title="Refresh halaman">Refresh</a>    
											@endif
										</div>
									...
									<div align="right">{{ $barang_keluar->appends(Request::only('search'))->links() }}</div>
								</div>
							</div>
						</div>
					</div>
