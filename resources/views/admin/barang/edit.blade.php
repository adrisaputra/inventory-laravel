							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" name="barcode" class="form-control @if ($errors->has('barcode')) is-invalid @endif " value="{{ $barang->barcode }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" name="nama_barang" class="form-control @if ($errors->has('nama_barang')) is-invalid @endif " value="{{ $barang->nama_barang }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" name="satuan" class="form-control @if ($errors->has('satuan')) is-invalid @endif " value="{{ $barang->satuan }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" name="harga" class="form-control @if ($errors->has('harga')) is-invalid @endif " value="{{ number_format($barang->harga, 0, ',', '.') }}" onkeyup="formatRupiah(this, '.')">
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input type="text" name="stok" class="form-control @if ($errors->has('stok')) is-invalid @endif " value="{{ number_format($barang->stok, 0, ',', '.') }}" onkeyup="formatRupiah(this, '.')">
